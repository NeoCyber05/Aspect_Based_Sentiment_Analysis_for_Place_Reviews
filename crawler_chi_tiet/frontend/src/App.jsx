  ...
  return (
    <div className="app-shell">
      ...
      <section className="panel jobs-panel">
        <div className="panel-heading" style={{ flexDirection: "column", alignItems: "flex-start", gap: "12px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", width: "100%", alignItems: "center" }}>
            <div>
              <p className="eyebrow">Theo dõi</p>
              <h2>Danh sách job</h2>
            </div>
            <span className="job-count">{jobs.filter((j) => (j.crawl_mode || "full") === activeTab).length} job</span>
          </div>
          
          <div className="tabs" style={{ display: "flex", gap: "8px", borderBottom: "1px solid #e2e8f0", paddingBottom: "8px", width: "100%" }}>
            <button 
              type="button" 
              className={`tab-btn ${activeTab === "full" ? "active" : ""}`}
              onClick={() => setActiveTab("full")}
              style={{ padding: "8px 16px", background: activeTab === "full" ? "#e2e8f0" : "transparent", border: "none", borderRadius: "4px", cursor: "pointer", fontWeight: activeTab === "full" ? "bold" : "normal" }}
            >
              Danh sách tải full
            </button>
            <button 
              ...
              style={{ padding: "8px 16px", background: activeTab === "train" ? "#e2e8f0" : "transparent", border: "none", borderRadius: "4px", cursor: "pointer", fontWeight: activeTab === "train" ? "bold" : "normal" }}
            >
              Danh sách tải train
            </button>
          </div>
        ...
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              {jobs.filter((j) => (j.crawl_mode || "full") === activeTab).length === 0 ? (
                <tr>
                ...
                jobs.filter((j) => (j.crawl_mode || "full") === activeTab).map((job) => (
                  <tr key={job.id}>
